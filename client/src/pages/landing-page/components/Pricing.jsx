  ...
  return (
        ...
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 pt-5">
            ...
            <img src="/assets/img/icons/dasar.svg "className="mx-auto w-20" />
                ...
                <span className="text-2xl text-tw-primary font-semibold">Rp. 100.000</span>
                <span className="text-gray-500 dark:text-gray-400 mx-3">/Bulan</span>
                </div>

                <div className="flex justify-center items-baseline mb-4">
                    <span className="mr-1 text-lg text-[#A7ACB2]">Rp. 1000.000</span>
                    <span className="text-[#A7ACB2]">/Tahun</span>
                </div>
                ...
                <a href="#" className="text-white bg-tw-primary hover:bg-[#7a8a07] font-medium rounded-lg text-sm px-5 py-2.5 text-center">Get started</a>
            </div>
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <img src="/assets/img/icons/team.svg "className="mx-auto w-20" />
            <h3 className="pt-10 text-2xl">Tim</h3>
            <div className="flex justify-center items-baseline mt-4 mb-1">
                <span className="text-2xl text-tw-primary font-semibold">Rp. 250.000</span>
                <span className="text-gray-500 dark:text-gray-400 mx-3">/Bulan</span>
                </div>

                <div className="flex justify-center items-baseline mb-4">
                    <span className="mr-1 text-lg text-[#A7ACB2]">Rp. 2.500.000</span>
                    <span className="text-[#A7ACB2]">/Tahun</span>
                </div>
                <ul role="list" className="mb-8 space-y-4 text-left">
                    <li className="flex items-center space-x-3">
            ...
            <div className="flex justify-center items-baseline mt-4 mb-1">
                <span className="text-2xl text-tw-primary font-semibold">Rp. 300.000</span>
                <span className="text-gray-500 dark:text-gray-400 mx-3">/Bulan</span>
                </div>

                <div className="flex justify-center items-baseline mb-4">
                    <span className="mr-1 text-lg text-[#A7ACB2]">Rp. 3000.000</span>
                    <span className="text-[#A7ACB2]">/Tahun</span>
                </div>
                <ul role="list" className="mb-8 space-y-4 text-left">
                    <li className="flex items-center space-x-3">
