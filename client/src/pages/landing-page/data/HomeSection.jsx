export const HomeSection ={
    content : ` <h2 className="text-3xl text-center md:text-left md:text-5xl !font-bold text-tw-primary pr-3">Satu dashboard untuk mengelola ternak sapi anda</h2>
                ...
                panjang untuk mengubah cara Anda bekerja.</p>
                <p className="text-center md:text-left"><a href="/auth/login" className="text-white bg-tw-primary hover:bg-[#7a8a07] font-medium rounded-lg text-sm px-5 py-2.5">Get started</a></p>`
